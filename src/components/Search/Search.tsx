...
const Search = ({ searchValue, handleSearch, className }: SearchProp) => {
  return (
    <div
      className={cn(
        "flex items-center gap-[7px] cursor-pointer flex-1 bg-white px-2 rounded-full",
        className
      )}
    >
      <svg
